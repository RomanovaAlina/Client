...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->войтиToolStripMenuItem->Size = System::Drawing::Size(152, 22);
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) //кнопка "войти"
				...
				if (textBox1->Text != " " && textBox1->Text != "")
            {
               ...
               //if (ip!=NULL)
               // {
				//connect(socket(AF_UNSPEC, SOCK_STREAM,IPPROTO_TCP),(struct sockaddr *)&anAddr, sizeof(struct sockaddr));//подключение к серверу
